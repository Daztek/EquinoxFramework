...
void VersionCheck_OnClientConnect()
{
    ...
    {
        WriteLog(VERSION_LOG_TAG, "Player '" + EM_GetNWNXString("PLAYER_NAME") + "' (" + EM_GetNWNXString("CDKEY") + ") tried to connect with version: " + IntToString(nMajor) + "." + IntToString(nMinor));
