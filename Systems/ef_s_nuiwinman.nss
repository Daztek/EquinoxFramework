...
void NWM_Init()
{
    EFCore_ExecuteFunctionOnAnnotationData(NWM_SCRIPT_NAME, "NWMWINDOW", "NWM_RegisterWindow({DATA});");
    EFCore_ExecuteFunctionOnAnnotationData(NWM_SCRIPT_NAME, "NWMEVENT", "NWM_RegisterEvent({DATA});");
}
