...
const float AV_TILES_TILE_SCALE                 = 0.125f;
...
{
    int nWidth = AV_AREA_WIDTH;
    int nHeight = Random(AV_AREA_HEIGHT) + 4;
    ...
    AG_CopyEdgeFromArea(AV_AREA_ID, GetObjectByTag("AR_TOWN"), AG_AREA_EDGE_TOP);
...
void AG_DelayedApplyEffect(object oDisplay, int nTile, int nTileID, int nOrientation, int nHeight)
{
    ...
    int nTileX = nTile % AV_AREA_WIDTH;
    int nTileY = nTile / AV_AREA_WIDTH;
